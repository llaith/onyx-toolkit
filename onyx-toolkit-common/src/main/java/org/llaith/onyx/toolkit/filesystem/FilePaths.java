...
public class FilePaths {
    ...
    private static class TheFilePath implements SomePath, Directory, RegularFile {
        ...
        public Directory createDirectory() {
            ...
            ExceptionUtil.rethrow(() -> Files.createDirectories(this.path));
        ...
        public RegularFile createRegularFile(final boolean overwrite) {
            ...
            if (this.exists()) {
                ...
                ExceptionUtil.rethrow(() -> Files.createFile(this.path));
        ...
        public Date creationDate() {
            ...
            return new Date(ExceptionUtil.rethrowOrReturn(() -> Files
