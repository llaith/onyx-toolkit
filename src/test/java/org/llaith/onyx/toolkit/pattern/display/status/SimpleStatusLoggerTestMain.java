...
import org.llaith.onyx.toolkit.pattern.display.progress.ProgressControl;
import org.llaith.onyx.toolkit.pattern.display.progress.ProgressTextRenderer;
import org.llaith.onyx.toolkit.pattern.stage.Context;
import org.llaith.onyx.toolkit.pattern.stage.Stage;
import org.llaith.onyx.toolkit.pattern.stage.ext.ConsoleLoggingStageListener;
import org.llaith.onyx.toolkit.lang.ThreadUtil;
...
import static org.llaith.onyx.toolkit.pattern.stage.ext.ContextAwareConsoleFormatter.consoleStatusReporter;

/**
 * Simple logger which does not support updating existing messages.
 */
public class SimpleStatusLoggerTestMain {
